...
class PatientTissueDataset(Dataset):
    def __init__(self, graphs_dir, clinical_df, target_col, transform=None, pre_transform=None):
        ...
        self.clinical_df = self.clinical_df.set_index('bcr_patient_barcode')
    ...
    def update_clinical_df(self, new_df_clinical):
        self.clinical_df = new_df_clinical.set_index('bcr_patient_barcode')
